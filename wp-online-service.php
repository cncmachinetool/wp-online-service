...
class WP_Online_Service {
    ...
    public function register_settings() {
        ...
        $channel_fields = [
            ...
            'wechat_qr_url' => __('WeChat QR code image URL', 'wp-online-service'),
    ...
    public function enqueue_assets() {
        ...
        wp_localize_script('wp-online-service-widget', 'wpOnlineService', [
            ...
            'channels' => [
                ...
                'wechatQr' => $options['wechat_qr_url'],
                'email' => $options['email'],
                'phone' => $options['phone'],
            ],
            'i18n' => [
    ...
    public function render_widget() {
        ...
        <div class="wp-online-service" aria-live="polite">
            <button class="wp-online-service__toggle" aria-expanded="true" aria-controls="wp-online-service-panel">
            ...
            <div class="wp-online-service__panel" id="wp-online-service-panel">
            ...
            <?php if (!empty($options['wechat_qr_url'])) : ?>
                <div class="wp-online-service__modal" id="wp-online-service-wechat" hidden>
                    <div class="wp-online-service__modal-backdrop"></div>
                    <div class="wp-online-service__modal-content" role="dialog" aria-modal="true" aria-labelledby="wp-online-service-wechat-title">
                        <button type="button" class="wp-online-service__modal-close" aria-label="<?php esc_attr_e('Close', 'wp-online-service'); ?>">&times;</button>
                        <h3 id="wp-online-service-wechat-title"><?php esc_html_e('Scan WeChat QR code', 'wp-online-service'); ?></h3>
                        <div class="wp-online-service__qr">
                            <img src="<?php echo esc_url($options['wechat_qr_url']); ?>" alt="<?php esc_attr_e('Scan to add us on WeChat', 'wp-online-service'); ?>" loading="lazy" />
                        </div>
                        <?php if (!empty($options['wechat_id'])) : ?>
                            <p class="wp-online-service__qr-note"><?php esc_html_e('WeChat ID:', 'wp-online-service'); ?> <?php echo esc_html($options['wechat_id']); ?></p>
                        <?php endif; ?>
                    </div>
                </div>
            <?php endif; ?>
